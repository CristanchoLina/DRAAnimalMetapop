...
N0s = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25endemic_vacc50reps/fixed_parameters/N0s.txt')
L = len(N0s)
delta, nb_steps = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25endemic_vacc50reps/fixed_parameters/setting.txt')
nb_steps = int(nb_steps*2)
demo_params = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25endemic_vacc50reps/fixed_parameters/demo_params.txt')
theta_edges = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25endemic_vacc50reps/fixed_parameters/theta_edges.txt')
...
combinations_task_id = np.genfromtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25endemic_vacc50reps/combinations/combinations_'+ task_id + '.txt', dtype='str') #task_id
