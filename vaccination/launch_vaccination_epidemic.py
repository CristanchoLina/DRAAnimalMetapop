...
import Epi_decision_functions_budgetonanimals as epidec
...
N0s = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25epidemic_vacc50reps/fixed_parameters/N0s.txt')
L = len(N0s)
delta, nb_steps = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25epidemic_vacc50reps/fixed_parameters/setting.txt')
nb_steps = int(nb_steps)
demo_params = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25epidemic_vacc50reps/fixed_parameters/demo_params.txt')
theta_edges = np.loadtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25epidemic_vacc50reps/fixed_parameters/theta_edges.txt')



#Decision times(fct of nb of steps and duration decision)
farmers_duration = 180/delta
...
def model_full(variable_parameters_list, fixed_parameters_list = fixed_parameters_list):
    ...
    budget = np.sum(herds_sizes)*0.25
...
combinations_task_id = np.genfromtxt('/home/maiage/lcristancho/SIMULATIONS/Centralised_Code/Cluster_25epidemic_vacc50reps/combinations/combinations_'+ task_id + '.txt', dtype='str') #task_id
...
# Write the array to disk
with open('prop_vaccinated_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
np.savetxt('wasted_doses_original_shape_' + task_id + '.txt',
           wasted_doses_original_shape, fmt='%1.2f')

# Write the array to disk
with open('wasted_doses_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
