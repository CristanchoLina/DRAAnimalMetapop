...
with open('simulated_data_vaccend_dynamic/' +'scores_' + task_id + '.txt', 'w') as outfile:
...
# Write the array to disk
with open('simulated_data_vaccend_dynamic/' +'decision_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_vaccend_dynamic/' +'prop_vaccinated_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_vaccend_dynamic/' +'daily_prop_infected_farms_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_vaccend_dynamic/' +'daily_infected_animals_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_vaccend_dynamic/' +'wasted_doses_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
