...
nb_steps = int(nb_steps*2) ##################################EnDEMIC SCENARIO HEREEEEE!!!!
...
combinations_task_id = np.genfromtxt('DRAAnimalMetapop/vaccination/dynamic/score_list/combinations_'+ task_id + '.txt', dtype='str') #task_id
...
with open('DRAAnimalMetapop/vaccination/dynamic/simulated_data_vaccend_dynamic/' +'scores_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
    outfile.write('DRAAnimalMetapop/vaccination/dynamic/# Array shape: {0}\n'.format(scores_original_shape))
    ...
    for data_slice in scores:
        ...
        outfile.write('DRAAnimalMetapop/vaccination/dynamic/# New step \n')
...
# Write the array to disk
with open('DRAAnimalMetapop/vaccination/dynamic/simulated_data_vaccend_dynamic/' +'decision_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('DRAAnimalMetapop/vaccination/dynamic/simulated_data_vaccend_dynamic/' +'prop_vaccinated_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('DRAAnimalMetapop/vaccination/dynamic/simulated_data_vaccend_dynamic/' +'daily_prop_infected_farms_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('DRAAnimalMetapop/vaccination/dynamic/simulated_data_vaccend_dynamic/' +'daily_infected_animals_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('DRAAnimalMetapop/vaccination/dynamic/simulated_data_vaccend_dynamic/' +'wasted_doses_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
