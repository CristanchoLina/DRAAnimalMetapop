...
# In[19]:
np.savetxt('percolation_treatment_endemic_data/'+'prop_infected_farms_end_' + task_id + '.txt', prop_infected_farms_end, fmt='%1.2f')

# In[19]:
np.savetxt('percolation_treatment_endemic_data/'+'auc_' + task_id + '.txt', auc, fmt='%1.2f')

# In[19]:
np.savetxt('percolation_treatment_endemic_data/'+'extinction_time_' + task_id + '.txt', extinction_time, fmt='%1.2f')
...
with open('percolation_treatment_endemic_data/'+'used_doses_I_number_' + task_id + '.txt', 'w') as outfile:
...
# Write the array to disk
with open('percolation_treatment_endemic_data/'+'used_doses_N_number_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
