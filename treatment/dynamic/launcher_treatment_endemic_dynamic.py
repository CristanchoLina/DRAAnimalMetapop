...
with open('simulated_data_treatend_dynamic/' +'scores_' + task_id + '.txt', 'w') as outfile:
...
# Write the array to disk
with open('simulated_data_treatend_dynamic/' +'decision_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_treatend_dynamic/' +'daily_prop_infected_farms_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_treatend_dynamic/' +'daily_infected_animals_dynamic_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_treatend_dynamic/' +'used_doses_I_number_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
...
# Write the array to disk
with open('simulated_data_treatend_dynamic/' +'used_doses_N_number_' + task_id + '.txt', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
